...
class Arena {
    ...
    public static function addArena(Player $player, string $arena, string $slots, string $id) {
        ...
        SkyWars::$data['id'][$player->getName()] = $id;
    ...
    public static function setLobbyWaiting(Player $player) {
        $config = SkyWars::getConfigs('Arenas/SW-' . SkyWars::$data['id'][$player->getName()]);
        $config->set('lobby', [
            $player->getX(),
            $player->getY(),
            $player->getZ()
        ...
        $config->save();
        $player->sendMessage(Color::GREEN . 'Lobby registered with id: ' . SkyWars::$data['id'][$player->getName()]);
    }
    ...
    public static function setLobbySpecters(Player $player) {
        ...
        $config->save();
        $player->sendMessage(Color::GREEN . 'Spectator lobby successfully registered to id: ' . SkyWars::$data['id'][$player->getName()]);
    }
    ...
    public static function setSpawns(Player $player, string $value) {
        ...
        $config->save();
        $player->sendMessage(Color::GREEN . 'Spawn-' . $value . ' registrado con exito en id: ' . SkyWars::$data['id'][$player->getName()]);
    }
